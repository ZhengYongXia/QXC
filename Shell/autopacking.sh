...
echo "\033[33;1m1. QXC \033[0m"
echo "\033[33;1m2. QXCTest \033[0m"
echo "\033[33;1m3. QXCRelease \033[0m"
echo "\033[33;1m4. QXCAppStore \033[0m\n"
...
__SCHEME_NAME="QXCTest"
elif [[ "${__SCHEME_NAME_SELECTED}" == "3" ]]; then
__SCHEME_NAME="QXCRelease"
elif [[ "${__SCHEME_NAME_SELECTED}" == "4" ]]; then
__SCHEME_NAME="QXCAppStore"
else
...
ExportOptionsPlistPath="./Shell/Plist/ExportOptions.plist"
